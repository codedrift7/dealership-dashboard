...
### Login Page
Secure authentication screen for user sign-in.
![Login page](screenshots/login.png)

### Dashboard Overview
Main dashboard displaying KPIs, charts, and overall business metrics.
![Dashboard overview](screenshots/dashboard-overview.png)

### Revenue by Brand
Bar chart showing revenue generated by each product brand.
